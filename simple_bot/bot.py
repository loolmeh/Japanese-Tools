...
scripts = [('cdecl', '../cdecl/c.sh'),
           ...
           ('lhc', '../lhc/lhc_info.sh'),
           ('fapme', '../fapme/fapme.sh'),
	   ('anime', '../anime/anime.sh'),
           ('tato', '../tato/tato.sh'),
           ('time', '../time/time.sh'),
           ('weather', '../weather/weather.sh'),
           ('stroke', '../stroke/stroke.sh'),
           ('penji', '../penji/penji.sh'),
           ('sanseido', '../sanseido/sanseido.sh'),
           ('esanseido', '../sanseido/esanseido.sh'),
           ('anki', '../anki/anki.sh'),
           ('doku', '../tadoku/tadoku.sh'),
	   ('danbooru', '../danbooru/danbooru.sh'),
	   ('pixiv', '../pixiv/pixiv.sh'),
	   ('meikyou', '../eb/meikyou.sh'),
	   ('shinmeikai', '../eb/shinmeikai.sh'),
	   ('shinjirin', '../eb/shinjirin.sh'),
	   ('koujien', '../eb/koujien.sh'),
	   ('kanjigen', '../eb/kanjigen.sh'),
	   ('kenkyuusha', '../eb/kenkyuusha.sh'),
	   ('shogakukan', '../eb/shogakukan.sh'),
	   ('edict', '../edict/edict.sh'),
	   ('jmdict', '../jmdict/jm.sh'),
	   ('define', '../gd/gd.sh'),
	   ('wiki', '../wiki/wiki.sh'),
	   ('jwiki', '../wiki/jwiki.sh'),
